  ...
  return (
    <>
      ...
      <div className="relative flex items-center">
        <div id={"slider"}>
          {movies.map((item, id) =>item.backdrop_path && (
            <div key={item.id} className="w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2">
                ...
                <p>
                  {like ?<BiMovie className="absolute top-4 left-4 text-gray-300"/> : <BiSolidMovie className="absolute top-4 left-4 text-gray-300"/> }
                </p>
                  </div>
                </div>
              ))}
